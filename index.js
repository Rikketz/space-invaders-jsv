...
class Invader {
    ...
    shoot(invadersProjectile){
        invadersProjectile.push(new InvaderProjectile({
            position: {
...
class Grid {
    constructor() {
        ...
        this.width = columns * 50; // Estos 50 son el tamaño de cada invader
...
function crearParticulas({object, color, fades}){
    for (let i = 0; i < 15; i++) {
        particles.push(new Particle({
            position: {
...
function animate(){
    ...
    // los proyectiles le dan a un enemigo
    ...
    invaderProjectiles.forEach((invaderProjectile, index) => {
        ...
        // los proyectiles enemigos le dan al jugador
            ...
            projectiles.forEach((projectile, i) => {
                if (projectile.position.y - projectile.radius <= invader.position.y + invader.height
                    ...
                    setTimeout(() => {
                        ...
                        // se elimina el enemigo y el proyectil que le impacta
